...
export var url = format(urlRegex, "Must be a url and start with http://");
export var email = format(emailRegex, "Must be an email address.");
export var dateISO = format(dateISORegex, "Must be in date ISO format.");
export var number = format(numberRegex, "Must be a number");
